...
def schedule_job(script_path, output, minute_periodicity=0, hour_periodicity=0, at_boot=False):
    interpreter_path = sys.executable
    command = "{} {} > {}/log.txt 2>{}/errors.txt".format(interpreter_path, script_path, output,
                                                              output)
